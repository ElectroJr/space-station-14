...
public sealed partial class ReplaySpectatorSystem
{
    ...
    private void InitializeMovement()
    {
        ...
        CommandBinds.Builder
            ...
            .Register<Spectator.ReplaySpectatorSystem>();
    }

    private void ShutdownMovement()
    {
        CommandBinds.Unregister<Spectator.ReplaySpectatorSystem>();
    }
    ...
    {
        private readonly Spectator.ReplaySpectatorSystem _sys;
        private readonly DirectionFlag _dir;

        public MoverHandler(Spectator.ReplaySpectatorSystem sys, DirectionFlag dir)
        {
            _sys = sys;
            _dir = dir;
        }
