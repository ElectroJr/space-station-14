...
public sealed class ChameleonSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ChameleonComponent, SetShaderAttemptEvent>(OnShaderSet);
    ...
    private void OnRemove(EntityUid uid, ChameleonComponent component, ComponentRemove args)
    {
        ...
        _sprite.SetPostShader(uid, null, sprite);
    ...
    private void OnAdd(EntityUid uid, ChameleonComponent component, ComponentInit args)
    {
        ...
        _sprite.SetPostShader(uid, _shader, sprite);
    ...
    private void OnShaderSet(EntityUid uid, ChameleonComponent component, SetShaderAttemptEvent args)
    {
